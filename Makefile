#############################################################################
# Makefile for building: ocelot
# Generated by qmake (3.1) (Qt 5.11.1)
# Project:  ocelot.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile ocelot.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQT_MULTIMEDIA_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_SQL_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/include/taglib -isystem /usr/include/qt -isystem /usr/include/qt/QtMultimedia -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtSql -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/qt/mkspecs/linux-g++
...
DISTDIR = /home/matheus/dev/projects/ocelot/.tmp/ocelot1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -ltag -lQt5Multimedia -lQt5Widgets -lQt5Gui -lQt5Network -lQt5Sql -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents pak.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/library.hpp src/workbench.hpp cwidgets/coverview.hpp cwidgets/tagview.hpp cwidgets/splitter.hpp cwidgets/progslider.hpp cwidgets/playlist.hpp cwidgets/libtree.hpp cwidgets/volslider.hpp dialogs/about.hpp cwidgets/toolbar.hpp dialogs/settings.hpp src/mwindow.hpp src/vars.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/library.cpp src/workbench.cpp cwidgets/coverview.cpp cwidgets/libtree.cpp cwidgets/playlist.cpp cwidgets/progslider.cpp cwidgets/splitter.cpp cwidgets/tagview.cpp cwidgets/volslider.cpp dialogs/about.cpp cwidgets/toolbar.cpp dialogs/settings.cpp src/mwindow.cpp src/vars.cpp $(DISTDIR)/
...
compiler_rcc_make_all: qrc_pak.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_pak.cpp
qrc_pak.cpp: pak.qrc \
		/usr/bin/rcc \
		internals/pause.png \
		internals/play.png \
		...
		internals/icon.png \
		internals/prev.png \
		internals/wrench.png \
		internals/stop.png
	/usr/bin/rcc -name pak pak.qrc -o qrc_pak.cpp
...
compiler_moc_header_make_all: moc_mwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mwindow.cpp
moc_mwindow.cpp: src/libmgr.hpp \
		src/workbench.hpp \
		src/library.hpp \
		src/database.hpp \
		src/vars.hpp \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/matheus/dev/projects/ocelot -I/usr/include/taglib -I/usr/include/qt -I/usr/include/qt/QtMultimedia -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtSql -I/usr/include/qt/QtCore -I/usr/include/c++/8.2.1 -I/usr/include/c++/8.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/8.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include-fixed -I/usr/include src/mwindow.hpp -o moc_mwindow.cpp
...
main.o: src/main.cpp src/mwindow.hpp \
		src/libmgr.hpp \
		src/workbench.hpp \
		src/library.hpp \
		src/database.hpp \
...
library.o: src/library.cpp src/library.hpp \
		src/database.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o library.o src/library.cpp

workbench.o: src/workbench.cpp src/workbench.hpp \
		src/library.hpp \
		src/database.hpp \
		src/vars.hpp \
		src/mwindow.hpp \
		...
		cwidgets/playlist.hpp \
		cwidgets/splitter.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o workbench.o src/workbench.cpp

coverview.o: cwidgets/coverview.cpp cwidgets/coverview.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o coverview.o cwidgets/coverview.cpp

libtree.o: cwidgets/libtree.cpp cwidgets/libtree.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o libtree.o cwidgets/libtree.cpp

playlist.o: cwidgets/playlist.cpp cwidgets/playlist.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o playlist.o cwidgets/playlist.cpp

progslider.o: cwidgets/progslider.cpp cwidgets/progslider.hpp \
		cwidgets/toolbar.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o progslider.o cwidgets/progslider.cpp

splitter.o: cwidgets/splitter.cpp cwidgets/splitter.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o splitter.o cwidgets/splitter.cpp

tagview.o: cwidgets/tagview.cpp cwidgets/tagview.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tagview.o cwidgets/tagview.cpp

volslider.o: cwidgets/volslider.cpp cwidgets/volslider.hpp \
		cwidgets/toolbar.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o volslider.o cwidgets/volslider.cpp

about.o: dialogs/about.cpp dialogs/about.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o about.o dialogs/about.cpp

toolbar.o: cwidgets/toolbar.cpp cwidgets/toolbar.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o toolbar.o cwidgets/toolbar.cpp

settings.o: dialogs/settings.cpp dialogs/settings.hpp \
		src/libmgr.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o settings.o dialogs/settings.cpp

mwindow.o: src/mwindow.cpp src/mwindow.hpp \
		src/libmgr.hpp \
		src/workbench.hpp \
		src/library.hpp \
		src/database.hpp \
		...
		cwidgets/toolbar.hpp \
		cwidgets/progslider.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mwindow.o src/mwindow.cpp

vars.o: src/vars.cpp src/vars.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vars.o src/vars.cpp

qrc_pak.o: qrc_pak.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_pak.o qrc_pak.cpp
