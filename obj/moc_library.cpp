...
QT_MOC_LITERAL(3, 18, 5), // "added"
QT_MOC_LITERAL(4, 24, 3), // "lib"
QT_MOC_LITERAL(5, 28, 7) // "process"

    },
    "library\0finished\0\0added\0lib\0process"
};
...
void library::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&library::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (library::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&library::added)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void library::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void library::added(QString _t1)
{
