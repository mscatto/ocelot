...
// fancy some pasta?
flac::flac(QWidget *parent) : QWidget(parent){
    ...
    connect(encslider, &QSlider::valueChanged, this, &flac::refresh_enclevel);
    ...
    connect(keepcheckb, &QCheckBox::clicked, this, &flac::flip_encsrate);
    ...
    bdh->setText("Keep");
    bdh->setChecked(true);
    connect(bdh, &QCheckBox::clicked, this, &flac::flip_encbdepth);
    ...
    connect(enc, &QCheckBox::clicked, this, &flac::flip_encpath);

    this->encline = new QLineEdit;
    this->encline->setPlaceholderText("/path/to/flac");
    ...
    connect(pck, &QPushButton::clicked, this, &flac::pick_enc);
