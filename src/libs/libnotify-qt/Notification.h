...
enum ServerInfo { SERVER_INFO_NAME = 0, SERVER_INFO_VENDOR, SERVER_INFO_VERSION };

enum NotificationUrgency { NOTIFICATION_URGENCY_LOW, NOTIFICATION_URGENCY_NORMAL, NOTIFICATION_URGENCY_CRITICAL };
...
public:
    ...
    Notification(const QString& summary, const QString& body = QString(), const QString& iconName = QString(), QObject* parent = 0);
    ~Notification();
    ...
    void setIconFromByteArray(const QByteArray& arr);
