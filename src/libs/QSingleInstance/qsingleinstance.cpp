...
QSingleInstance::QSingleInstance (QObject *parent) : QObject (parent), d (new QSingleInstancePrivate (this)) {
	resetInstanceID();
}
...
bool QSingleInstance::resetInstanceID() {
	...
	QByteArray hashBase =
		(QCoreApplication::organizationName() + QLatin1Char ('_') + QCoreApplication::applicationName()).toUtf8();
