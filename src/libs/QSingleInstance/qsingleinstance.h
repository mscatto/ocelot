...
public:
    ...
    template <typename T = void> void setNotifyWindow(QWindow* window);
#endif
#ifdef QT_WIDGETS_LIB
    //! Sets a window to be activted on new received arguments
    template <typename T = void> void setNotifyWindow(QWidget* widget);
#endif
...
#ifdef QT_GUI_LIB
template <typename T> void QSingleInstance::setNotifyWindow(QWindow* window) {
...
#ifdef QT_WIDGETS_LIB
template <typename T> void QSingleInstance::setNotifyWindow(QWidget* widget) {
