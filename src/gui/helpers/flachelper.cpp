...
flachelper::flachelper (QWidget *parent) : QWidget (parent) {
	...
	brcombob->addItems (QStringList() << "44kHz"
									  << "96kHz");
	...
	bdcombob->addItems (QStringList() << "16bits"
									  << "24bits");
...
void flachelper::pick_enc() {
	QUrl enc = QFileDialog::getOpenFileUrl (this, "Path to custom flachelper Encoder", QDir::homePath());
